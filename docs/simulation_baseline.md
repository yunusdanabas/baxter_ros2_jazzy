...
This document records the first public sim-first baseline for
`baxter_ros2_jazzy`. It is not a tagged GitHub release.
...
| `hardware_bridge` | experimental | Mock/action-shim code exists; no hardware support claim. |
| supervised hardware motion | unsupported | No hardware motion support claim. |
